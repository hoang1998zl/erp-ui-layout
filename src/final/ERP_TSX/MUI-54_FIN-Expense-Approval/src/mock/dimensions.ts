...
export function seedIfEmpty() {
  ...
  const values: DimensionValue[] = [
    ...
    { id: rid(), dim_code:'PROJECT', code:'PRJ-003', name_vi:'Mobile App Development', name_en:'Mobile App Development', active:true },
    { id: rid(), dim_code:'PROJECT', code:'PRJ-004', name_vi:'Digital Marketing Campaign', name_en:'Digital Marketing Campaign', active:true },
    { id: rid(), dim_code:'PROJECT', code:'PRJ-005', name_vi:'Infrastructure Upgrade', name_en:'Infrastructure Upgrade', active:true },
    ...
    { id: rid(), dim_code:'DEPT', code:'FINANCE', name_vi:'Tài chính', name_en:'Finance', active:true },
    { id: rid(), dim_code:'DEPT', code:'SALES', name_vi:'Kinh doanh', name_en:'Sales', active:true },
    { id: rid(), dim_code:'DEPT', code:'MARKETING', name_vi:'Marketing', name_en:'Marketing', active:true },
    { id: rid(), dim_code:'DEPT', code:'EXECUTIVE', name_vi:'Ban điều hành', name_en:'Executive', active:true },
  ];
