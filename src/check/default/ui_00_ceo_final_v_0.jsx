 ...
 * - Self-tests T1–T12 (incl. new sanity checks)
 */
        ...
        <div className="mx-auto max-w-[1400px] px-4">
          <div className="flex h-14 items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <Pill>UI 00 · CEO · Final {VERSION}</Pill>
                  ...
                  <motion.div key="mx" initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -8 }}>
                    <Matrix
                      ...
                      onSelectCell={(company, dept) => {
                        ...
                        // Auto-open chat modal per requirement
                        setChatOpen(true);
                      }}
                    />
